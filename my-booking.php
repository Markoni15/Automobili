  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Moje bukiranje</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Početna</a></li>
        <li>Moje rezervacije</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Moje bukiranje </h5>
...
<li>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Otkazano</a>
            <div class="clearfix"></div>
        </div>
