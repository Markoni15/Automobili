...
$chngpwd1->execute();
$msg="Lozinka je uspešno promenjena";
}
else {
$error="Trenutna lozinka je pogrešna";  
}
}
...
<form name="chngpwd" method="post" onSubmit="return valid();">
        ...
        else if($msg){?><div class="succWrap"><strong>Uspešno</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
            <div class="form-group">
              <label class="control-label">Stara šifra</label>
              <input class="form-control white_bg" id="password" name="password"  type="password" required>
            </div>
            
            <div class="form-group">
              <label class="control-label">Nova Šifra</label>
              <input class="form-control white_bg" id="newpassword" type="password" name="newpassword" required>
            </div>
            <div class="form-group">
              <label class="control-label">Potvrdi šifru</label>
