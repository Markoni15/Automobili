...
<title>Portal za rentiranje auta | Moj profil</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Opšta podešavanja</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>USPEŠNO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Poslednja izmena  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Mejl adresa</label>
            ...
            <div class="form-group">
              <label class="control-label">Vaša adresa</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Sačuvaj promene <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
